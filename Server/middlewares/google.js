...
passport.use("auth-google",
  new GoogleStrategy({
    ...
    callbackURL: "https://inmobiliaria360.up.railway.app/auth/google/callback",
...
if (!user) {
  ...
  await axios.post("https://inmobiliaria360.up.railway.app/mail/login", { email:userGoogle.email })
}
